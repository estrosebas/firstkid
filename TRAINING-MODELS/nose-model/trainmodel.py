...
# ---------- Rutas de dataset ----------
burned_dir = "C:/Users/estro/Desktop/rcp-model/nose-model/nariz_sangre"
...
base_model.trainable = False  # congelar pesos de ImageNet
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dropout(0.3),  # ayuda a generalizar
